...
model_path = './east_part/east_model'
            ...
            if boxes is not None:
                for box in boxes:
                        ...
                        if np.linalg.norm(box[0] - box[1]) < 5 or np.linalg.norm(box[3]-box[0]) < 5:
                            continue
                        line_box.append([box[0, 0], box[0, 1], box[1, 0], box[1, 1], box[2, 0], box[2, 1], box[3, 0], box[3, 1]])
                        # f.write('{},{},{},{},{},{},{},{}\r\n'.format(
...
if __name__ == '__main__':
    ...
    src_img = cv2.imread('./test_set/img_1.jpg', 1)

    img, line_box, _ = east_main(src_img)
